...
def Predict(company, start, end, n_previous, n_cluster):
    ...
    for i in range(n_previous, n_days):
        ...
        print "Predicting in",i - n_previous + 1,"th/", n_days - n_previous,"days..."
    ...
    print "Finished predicting",df.shape[0]-n_previous,"days in ", time.time() - start_time, " s"
...
Predict("IBM", start, end, n_previous = 100, n_cluster=10)
